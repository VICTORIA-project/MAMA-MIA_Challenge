...
# extractor.settings['force2D'] = True # -- doesn't work --
...
X_val, y_val, ids_val, _ = load_data(val_entries, feature_names=feature_names)# Validation features
print("📦 Extracting validation features...")
...
# selector = SelectKBest(score_func=f_classif, k=15)  # or use mutual_info_classif
...
# pd.DataFrame(X_val_scaled, columns=selected_features).to_csv(
#     "/home/hadeel/MAMA-MIA_Challenge/machine_learning/outputs/val_features_radiomics.csv", index=False)
