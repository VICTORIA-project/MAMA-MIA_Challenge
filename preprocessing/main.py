...
output_folder = os.path.join(dataset_path, 'processed_1st_post')
...
for patient_id in sorted(os.listdir(images_folder)):  
    ...
    if os.path.isdir(patient_path):
        ...
        if os.path.exists(file_path):
            ...
            clipped_sitk = clip_image_sitk(denoised_sitk, percentiles=[0.1, 99.9]) # newly added
            ...
            output_file_path = os.path.join(output_folder, f"{patient_id}_{phase_index:04d}_resampled.nii.gz")
